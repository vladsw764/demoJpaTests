...
public class LoggingServiceClassesAspect {
    ...
    public void logAfter(JoinPoint joinPoint, Object returningValue) {
        ...
        if (returningValue != null) {
            ...
            long res = Duration.between(LocalDateTime.now(), start).toMillis();
            log.debug(ANSI_BLUE + "Service: " + methodName + " - end. Execution time - " + res + ". Returns - {}" + ANSI_RESET, outputValue);
        } else {
